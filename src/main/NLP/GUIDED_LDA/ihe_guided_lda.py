...
class IheGuidedLda(GuidedLda):
    ...
    def run(self):
        ...
        keywords = "src/main/IHE_KEYWORDS/ihe_keywords.csv"
        iterations = 400
        seed_confidence = 1.0
        num_top_words = 20

        # IHE results files.
        pyldavis_html = "src/main/NLP/GUIDED_LDA/IHE_RESULTS/pyldavis.html"
        tsne_clusters_html = "src/main/NLP/GUIDED_LDA/IHE_RESULTS/tsne_clusters.html"
        model = "src/main/NLP/GUIDED_LDA/IHE_RESULTS/model.pkl"
        results = "src/main/NLP/GUIDED_LDA/IHE_RESULTS/training_results.json"
